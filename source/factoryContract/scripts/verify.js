...
async function main() {
  ...
  const princeLP = json.PrinceLP;
  console.log(wbnb, PancakeFactory, princeLP);
  ...
  //   address: wbnb,
  // });
  // console.log("wbnb verify:");

  // await run(`verify:verify`, {
  //   address: princeLP,
  // });
  // console.log("princeLP verify:");

  await run(`verify:verify`, {
    address: PancakeFactory,
    constructorArguments: [accountAddr],
  });
  console.log("kingFactory verify:");
}
